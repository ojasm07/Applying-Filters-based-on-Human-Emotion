...
def main():
    ...
    while True:
        ...
        # cv2.waitkey(1) halts the program for 1 millisecond so that the captured image can be displayed back to the user.
        # Check if the user hits the q character and, if so, quit the application
